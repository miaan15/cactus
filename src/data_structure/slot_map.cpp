...
export template <class T, class Key = std::pair<unsigned, unsigned>, template <class...> class Container = boost::container::vector>
class slot_map {
...
export template <class T, class Key, template <class...> class Container>
